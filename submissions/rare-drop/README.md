...
- **Source:** [Game and run instructions](https://github.com/horusuzu/rare-friends-lost-and-found/tree/383955840a00db2abb19bdf2017e9ab0c0f7826c/games/rare-drop). The source repository also contains Our Little Island and Rare Invaders; Rare Drop is a separate entry and URL.
...
Validated source revision: [`3839558`](https://github.com/horusuzu/rare-friends-lost-and-found/tree/383955840a00db2abb19bdf2017e9ab0c0f7826c). All checks below passed before submission. Engine coverage: 100% lines/functions, 97.83% branches. Automated browser checks use SDK wallet/RPC fixtures; screenshots show fixture Friend #7730, not a claim of ownership.
